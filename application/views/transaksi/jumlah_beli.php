...
<!-- no_pembelian no_notabeli idpegawai idsupplier jenis tgl_masuk catatan -->
    ...
    <div class="row">
        ...
        <form action="" method="post">
            ...
            <input type="hidden" name="id" id="id" value="<?= $ketbarang['idbarang']; ?>">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="hrg_beli" name="hrg_beli">
                    <?= form_error('hrg_beli', '<small class="text-danger pl-3">', '</small>'); ?>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row justify-content-end">
                    ...
                    <a href="<?= base_url('transaksi/hapusidBarang'); ?>" name=detailBeli class="btn btn-secondary ">Kembali</a>
                </div>
            </div>
            </form>
        </div>
