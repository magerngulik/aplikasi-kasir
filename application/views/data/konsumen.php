            ...
            <div class="row">
                ...
                <div class="col-6">
                 <div class="row">
                    ...
                    <div class="col">
                        <a class="btn btn-danger" href="<?= base_url('data/allKonsumen') ?>"> All Data</a>
                    </div>
                </div>   
                ...
                <tbody>
                   ...
                   <?php endif?>
                    ...
                    <!-- idpelanggan	nm_konsumen	alamat no_telp -->
                        ...
                        <td><?= $sm['no_telp']; ?></td>
                        <td>
                            <a href="<?= base_url('data/editKonsumen/').$sm['idpelanggan']; ?>" class="badge badge-success">edit</a>
                            <a href="<?= base_url('data/hapusKonsumen/').$sm['idpelanggan']; ?>" onclick="return confirm('Apakah anda ingin menghapus data ini?');" class="badge badge-danger">Delete</a>
                        </td>
                    </tr>
                    <?php ?>
                    <?php endforeach; ?>
