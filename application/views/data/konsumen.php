                ...
                <tbody>
                   ...
                   <?php endif?>
                    ...
                    <!-- idpelanggan	nm_konsumen	alamat no_telp -->
                        ...
                        <td><?= $sm['no_telp']; ?></td>
                        <td>
                            <a href="<?= base_url('data/editKonsumen/').$sm['idpelanggan']; ?>" class="btn btn-primary">edit</a>
                            <a href="<?= base_url('data/hapusKonsumen/').$sm['idpelanggan']; ?>" onclick="return confirm('Apakah anda ingin menghapus data ini?');" class="btn btn-danger">Delete</a>
                        </td>
                    </tr>
                    <?php ?>
                    <?php endforeach; ?>
