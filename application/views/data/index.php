                ...
                <tbody>
                   ...
                   <?php endif?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?= base_url('data/editBarang/').$sm['idbarang']; ?>" class="badge badge-success">edit</a>
                            <a href="<?= base_url('data/hapusDataBarang/').$sm['idbarang']; ?>" onclick="return confirm('Apakah anda ingin menghapus data ini?');" class="badge badge-danger">Delete</a>
